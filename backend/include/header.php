<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo BACK_PLUGIN; ?>font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        ...
        <!-- BEGIN CORE PLUGINS -->
        <script src="<?php echo BACK_PLUGIN; ?>jquery.min.js" type="text/javascript"></script>
        <script src="<?php echo BACK_PLUGIN; ?>bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="<?php echo BACK_PLUGIN; ?>js.cookie.min.js" type="text/javascript"></script>
        <script src="<?php echo BACK_PLUGIN; ?>bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
        <script src="<?php echo BACK_PLUGIN; ?>jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo BACK_LAYOUT; ?>layout4/scripts/demo.min.js" type="text/javascript"></script>
        <script src="<?php echo BACK_LAYOUT; ?>global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
