<?php
  ...
  class Core
  {
      ...
      private function getSettings()
      {
          ...
          $this->site_url = SITEURLconfig;
		  $this->site_dir = SITEDIRconfig;
          ...
          $this->manager_verify = $row->manager_verify;
      ...
      public function processConfig()
      {
          ...
          Filter::checkPost('site_name','Website Name');
          ...
          if (empty(Filter::$msgs)) {
              $data = array(
                  ...
                  'manager_verify' => intval($_POST['manager_verify']),
